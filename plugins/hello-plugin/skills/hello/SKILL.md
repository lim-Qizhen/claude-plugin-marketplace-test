...
- If the user has asked for French, or the conversation is in French, read
  `../../reference/french.md` (relative to this skill's own directory) and
  follow its guidance.
- Otherwise, read `../../reference/english.md` (relative to this skill's own
  directory) and follow its guidance.
